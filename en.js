         ...
         // get the post labels from the entry
            ...
            if ("category" in entry) {
               for (var k = 0; k < entry.category.length; k++) {
                  pll += '<a href="javascript:filterPosts(\'' + entry.category[k].term + '\');" title="Click here to select all tagged items. \'' + entry.category[k].term + '\'">' + entry.category[k].term + '</a>,  ';
               }
...
// this function creates a three-column table and adds it to the screen
   var numDisplayed = 0;
   var tocTable = '';
   var tocHead1 = 'Title of the article';
   var tocTool1 = 'Click to sort by title';
   var tocHead2 = 'Publication date';
   ...
   if (postFilter != '') {
      tocTool3 = 'Click to view all articles';
   }
   tocTable += '<table>';
   tocTable += '<tr>';
   ...
   if (numDisplayed == postTitle.length) {
      var tocNote = '<span class="toc-note">Nombre de posts ' + postTitle.length + ' Posts<br/></span>'; }
   else {
      var tocNote = '<span class="toc-note">Nombre de posts ' + numDisplayed + ' Posts \'';
...
function showToc() {
  ...
  else { alert("Wait ... Index is loading"); }
}
...
"<div id=\"toc-loading\">Wait ... Index is loading<br /><img align=\"middle\" src=\"http://2.bp.blogspot.com/-WK0-4ILTaL8/T0NjToWRWlI/AAAAAAAABmI/U5p3cqo9lOU/s1600/loading.gif\" /></div>";
